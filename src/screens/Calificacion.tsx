...
function Secretarios() {
  ...
  return (
    <SideBarWithText  location = {"Progreso Académico"} sublocation = {"Calificación"}>
      <div className="w-100 h-100 btl bg-gray1">
        ...
        >
          <div className="d-flex col-11 ms-20 fw-bold">
            <strong className="fs-4 ms-6 me-81 pe-30">Cursos creados para la calificación de logros de indicadores de logros por asignatura</strong>
          </div>
