...
function Asignaturas() {
  ...
  return (
    <SideBarWithText location = {"Progreso Anual"} sublocation = {"Asignaturas"}>
      <div className="w-100 h-100 btl bg-gray1">
        ...
        >
          <div className="d-flex col-11 ms-20 fw-bold">
            <strong className="fs-4 ms-10 mb-3 me-81 pe-20">Asignaturas por Curso</strong>
          </div>
