...
function EstablecerAño() {
  ...
  return (
    <SideBarWithText location = {"Progreso Anual"} sublocation = {"Establecer Año"}>
      <div className="w-100 h-100 btl bg-gray1">
        ...
        >
          <div className="d-flex col-11 ms-20 fw-bold">
            <strong className="fs-4 ms-10 me-81 pe-20">Año Académico</strong>
            <button
              type="button"
              className="btn bg-blue3 btn-primary ms-81 w-64 mb-0 pb-0 h-10 btl btr "
            >
              <a>
                <h4 className="text-white fs-5">+ Nuevo Año</h4>
              </a>
            </button>
          </div>
